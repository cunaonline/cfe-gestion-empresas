CREATE ROLE rnlocal LOGIN
  ENCRYPTED PASSWORD 'md533ae401115b9b809783d430042b73b2a'
  NOSUPERUSER INHERIT NOCREATEDB CREATEROLE;

CREATE ROLE cfe_consulta LOGIN
  ENCRYPTED PASSWORD 'md5d69dff2d21bc5f44030b80c0e95e8fe6'
  NOSUPERUSER INHERIT NOCREATEDB NOCREATEROLE;

CREATE ROLE rn_backup LOGIN ENCRYPTED PASSWORD 'md58388961e2b9274f0c01f16fa98c7b3c6'
...
CREATE TABLE medios_de_pago(id_medio_de_pago bigserial NOT NULL,codigo integer,glosa character varying(50) NOT NULL,fecha_baja date,CONSTRAINT medios_de_pago_pkey PRIMARY KEY (id_medio_de_pago));
...
INSERT INTO PARAMETROS VALUES ('VERSION','VERSION DE LA APLICACION', '6.4.0', null, null,null, null, null);
...
id_sobre_re, id_cae_asignado, id_detalle_acuse_re, id_detalle_acuse_dgi, cant_lin_detalle, emitido_recibido, digest_firma, transporte FROM COMPROBANTES;
...
INSERT INTO PARAMETROS VALUES('HABILITAR_CFE_ENTRY',NULL,NULL,NULL,FALSE,NULL,NULL,NULL);
...
INSERT INTO PARAMETROS VALUES('CFEADENDA_SCHEMA_VALIDATION_FILE', NULL,'xsd/1.37_8/CFEEmpresas.xsd', NULL, NULL, NULL, NULL,NULL);
INSERT INTO PARAMETROS VALUES ('SOBRE_EMPRESAS_SCHEMA_VALIDATION_FILE','','xsd/1.37_8/EnvioCFE_entreEmpresas.xsd',NULL, NULL,NULL, NULL);
...
INSERT INTO parametros VALUES ( 'CTRL_VALIDAR_SUCURSALES', '', NULL, NULL, FALSE, NULL, NULL, NULL );
...
INSERT INTO percepciones_retenciones VALUES (1146, 185, 'RET. POR INC. PATRIM. S/PREMIOS JUEGOS AZAR -CARRERAS CABALLOS', NULL);
INSERT INTO percepciones_retenciones VALUES (1146, 85, 'RET. POR INC. PATRIM. S/PREMIOS JUEGOS AZAR -CARRERAS CABALLOS', NULL);
INSERT INTO percepciones_retenciones VALUES (1246, 185, 'RET. POR INC. PATRIM. S/PREMIOS JUEGOS AZAR -CARRERAS CABALLOS', NULL);
INSERT INTO percepciones_retenciones VALUES (1246, 195, 'RET. S/RENTAS X IMPORTACION BIENES - ENTID. BONT VINCULADA', NULL);
INSERT INTO percepciones_retenciones VALUES (1246, 196, 'RESP. SOLIDARIO X EXPORTACION BIENES - ENTID. BONT VINCULADA', NULL);
INSERT INTO percepciones_retenciones VALUES (2183, 80, 'IMP. ESPECIFICO A LAS APUESTAS A TRAVES DE MAQ. ELECT. O AUTO.', NULL);
...
CREATE INDEX IX_COMPROBANTE_DETALLE_ACUSE_RE ON COMPROBANTES (ID_DETALLE_ACUSE_RE, EMITIDO_RECIBIDO, ID_SOBRE_RE);
