...
CREATE TABLE CLIENTES (IDENTIFICADOR  VARCHAR(20) NOT NULL, DOCUMENTO  VARCHAR(20), NOMBRE VARCHAR(255), TIPO_DOCUMENTO INTEGER, CODIGO_PAIS_DOCUMENTO VARCHAR(2), DIRECCION VARCHAR(70), CIUDAD VARCHAR(30), DEPARTAMENTO VARCHAR(30), CODIGO_POSTAL VARCHAR(10), ACTIVO boolean, ID_CONDICION_PAGO BIGINT, ID_CONDICION_ENVIO BIGINT, ID_LISTA_PRECIOS BIGINT, PRIMARY KEY (IDENTIFICADOR));
...
INSERT INTO PARAMETROS VALUES ('VERSION','VERSION DE LA APLICACION', '6.1.0', null, null,null, null, null);
...
INSERT INTO PARAMETROS VALUES('CFEADENDA_SCHEMA_VALIDATION_FILE', NULL,'xsd/1.36/CFEEmpresas.xsd', NULL, NULL, NULL, NULL,NULL);
INSERT INTO PARAMETROS VALUES ('SOBRE_EMPRESAS_SCHEMA_VALIDATION_FILE','','xsd/1.36/EnvioCFE_entreEmpresas.xsd',NULL, NULL,NULL, NULL);
