...
CREATE TABLE USUARIOS (id_usuario serial NOT NULL,usuario character varying(30) NOT NULL,nombre_completo character varying(255),
  password character varying(40) NOT NULL,tipo character varying(1) NOT NULL,usuario_cfe boolean NOT NULL,usuario_cae boolean NOT NULL,
  ...
  alarma_reportes boolean NOT NULL DEFAULT false, activo BOOLEAN NOT NULL, acceso_server BOOLEAN NOT NULL, acceso_pdv BOOLEAN NOT NULL, hashed_password character varying(300), salt character varying(100), CONSTRAINT usuarios_pkey PRIMARY KEY (id_usuario ),  CONSTRAINT usuarios_usuario_key UNIQUE (usuario ));
...
CREATE TABLE SUCURSALES (CODIGO int4, NOMBRE VARCHAR(70), DOMICILIO_FISCAL VARCHAR(70) NOT NULL, FECHA_ALTA date, FECHA_BAJA date,  PRINCIPAL boolean, SUCURSAL_DATAENTRY boolean, PRIMARY KEY (CODIGO));
...
INSERT INTO PARAMETROS VALUES ('VERSION','VERSION DE LA APLICACION', '5.3.0', null, null,null, null, null);
...
INSERT INTO PARAMETROS VALUES('CFEADENDA_SCHEMA_VALIDATION_FILE', NULL,'xsd/1.34_7/CFEEmpresas.xsd', NULL, NULL, NULL, NULL,NULL);
INSERT INTO PARAMETROS VALUES ('SOBRE_EMPRESAS_SCHEMA_VALIDATION_FILE','','xsd/1.34_7/EnvioCFE_entreEmpresas.xsd',NULL, NULL,NULL, NULL);
...
INSERT INTO percepciones_retenciones VALUES (1144,331,'Ingresos comprendidos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,3,'IVA Autoconsumo','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1144,339,'FONASA - Reintegros por aportes en exceso','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1144,201,'Crédito Responsable Sustituto','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1144,332,'Crédito por retenciones en exceso','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1144,333,'Importes no retenidos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1144,334,'AFAP - Reintegros por aportes en exceso','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1144,335,'Ingresos correspondientes a Ej. anteriores','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1144,731,'Deducciones declaradas por el contribuyente','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1144,732,'Deducciones declaradas por el responsable sust.','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1144,735,'Deducciones correspondientes a Ej. Anteriores','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1145,201,'Crédito Responsable Sustituto','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1145,341,'Ingresos comprendidos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1145,342,'Crédito por retenciones en exceso','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1145,343,'Importes no retenidos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1145,345,'Ingresos correspondientes a ej. anteriores','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1145,741,'Deducciones declaradas por el contribuyente','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1145,742,'Deducciones declaradas por el responsable sust.','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1146,336,'Rentas de trabajo independiente','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1146,361,'Ingresos por rentas vitalicias','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1146,371,'Arrendamientos y sim.- con retención','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1146,372,'Arrendamientos y sim.- retención por otro agente','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1146,373,'Arrend. Contrib. Exonerados Lit.J','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1146,374,'CGN - Arrendamientos no retenidos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1146,377,'Arrend. Exonerado- Art.12','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1146,381,'Arrendamientos a turistas - con retencion','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1146,383,'Arrendamientos a turistas - exonerados','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1146,386,'Arrendamientos a turistas - restantes','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,337,'Ingr. por rentas trabajo Indep.- Conv Doble Impos.','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,355,'Ingresos por intereses - Conv. Doble Impos.','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,361,'Ingresos por rentas vitalicias','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,365,'Ingr. por divid. y utilid pagadas-Conv Doble Impos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,366,'Ingr. por der fede','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,367,'Ingr. por ganan. de capit mobilia-Conv Doble Impo.','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,371,'Arrendamientos y sim.- con retención','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,372,'Arrendamientos y sim. - retención por otro agente','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,374,'CGN - Arrendamientos no retenidos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,377,'Arrend. Exonerado- Art.12','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,381,'Arrendamientos a turistas - con retencion','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (1246,393,'Ingr. por rentas de act. empresa.-Conv Doble Impos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,41,'Dinero','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,42,'Deudores y Cuentas a Cobrar','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,44,'Valor Patrimonial de Obligaciones Nominativas','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,46,'Vehiculos de Transporte Terrestre/Maritimo/Aereo','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,49,'Otros Activos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,50,'Ajuar-Corresponde Si(1)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,51,'Ajuar-Importe por avaluo(Otra Base de Calculo)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,52,'Ajuar-Titulos de Ahorro u otros al port.suj.a ret.','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,53,'Ajuar-Oblig.nominativas que coticen en bolsa','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,54,'Ajuar-Oblig.al portador coticen o no en bolsa','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,55,'Ajuar-Depositos en instituciones bancarias','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,56,'Ajuar-Saldo de precios de imp.en M/E de pers.ext.','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,57,'Ajuar-Saldo de prest.y dep.en M/E de pers.ext.','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,58,'Ajuar-Inmuebles declarados monumentos historicos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,59,'Ajuar-Certificados de valor oro','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,61,'Total Activo en el Exterior','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,62,'Total Activo No computable','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,70,'Total Pasivo admitido en el pais','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,90,'Impuesto Retenido','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,91,'Anticipos Impuesto al Patrimonio','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,301,'Inmuebles urbanos y suburbanos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,302,'Inmuebles rurales no afectados a explot.agropec.','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,303,'Patrimonio Comercial y/o Industrial','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,401,'Minimo no Imponible del Sujeto Pasivo','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,402,'Pasivo Computable','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,403,'Monto Imponible para el calculo del Ajuar','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,404,'Ajuar','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,405,'Monto Imponible del Impuesto al Patrimonio','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,406,'Impuesto al Patrimonio','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2104,407,'Saldo o Credito','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2142,30,'Contrib.-IMEBA Plaza (Cod.573)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2142,31,'Contrib.-Adicional MEVIR Plaza (Cod.575)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2142,32,'Contrib.-Adicional INIA Plaza (Cod.577)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2142,40,'Contrib.-IMEBA Exportacion (Cod.583)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2142,41,'Contrib.-Adicional MEVIR Exportacion (Cod.585)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2142,42,'Contrib.-Adicional INIA Exportacion (Cod.587)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2142,50,'Deduc.- Ant. IMEBA en la Imp.(Cod.563)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2142,51,'Deduc.- Ant. Adic. MEVIR en la Imp.(Cod.565)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2142,52,'Deduc.- Ant. Adic. INIA en la Imp. (Cod.567)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,1,'IVA Compras de Importacion','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,2,'IVA Retenido Personas Exterior','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,10,'Compras plaza a territorio no franco','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,11,'Compras plaza a usuarios zona franca','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,12,'Compras al exterior','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,13,'IVA compras combustible','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,20,'Ventas plaza a territorio no franco','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,21,'Ventas plaza a zona franca (Usuarios y Otros)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,22,'Ventas al exterior','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,30,'Faena de aves-Pago a cta. IVA/COFIS 1º 10 dias','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,31,'Faena de aves-Pago a cta. Percepciones 1º 10 dias','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,32,'Faena de aves-Pago a cta. IVA/COFIS 2º 10 dias','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,33,'Faena de aves-Pago a cta. percepciones 2º 10 dias','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,34,'Faena de aves-Pago a cta. IVA/COFIS 3º 10 dias','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,35,'Faena de aves-Pago a cta. percepciones 3º 10 dias','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,59,'CFE - Software - Aplicativos propios','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,350,'CFE - Infraestructura - Equipamiento Central','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,351,'CFE - Infraestructura - Equipamiento Departamental','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,352,'CFE - Infraestructura - Equipos de puntos de venta','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,353,'CFE - Infraestructura - Red LAN','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,354,'CFE - Infraestructura - Red WAN','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,355,'CFE - Infraestructura - Equipos de Seguridad','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,356,'CFE - Infraestructura - Equipamiento Auxiliar','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,357,'CFE - Infraestructura - Otros elementos necesarios','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,358,'CFE - Software - Software de Base','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,359,'CFE - Software - Aplicativos de terceros','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,401,'IVA Compras de Proveedores','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,402,'Retenciones y/o Percep. Deducidas IVA-OTT-COFIS','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,403,'Retenciones y/o Percep. Deducidas IRIC/IRAE-IMP. P','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,404,'Retenciones y/o Percep. Deducidas IMP. COMISIONES','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,405,'Retenciones y/o Percep. Deducidas IMEBA','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,406,'Retenciones y/o Percep. Deducidas IRPF','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,409,'Creditos Deducidos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,450,'IVA - Importación de Explosivos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,451,'Anticipo IVA - Importación de Explosivos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,480,'Crédito productor agrop. - imp. enaj. semovientes','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,502,'IVA Ventas Tasa Basica a Contribuyentes','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,503,'IVA Ventas Tasa Minima a Contribuyentes','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,504,'Compras Plaza Exentas de IVA','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,505,'IVA Compras Plaza Tasa Basica','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,506,'IVA Compras Plaza Tasa Minima','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,507,'IVA Ventas tasa 10% a Contribuyentes','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,508,'IVA Compras Plaza Tasa 10%.','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,509,'IVA Ventas - Bancos','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,510,'Monotributo- Ventas tarjetas de crédito','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,511,'Proveedores de servicios de depósito-Dto 331/09','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,512,'Proveedores de servicio de frío-Dto. 331/09','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,513,'Compras a pescad. artesanales-Contrib. Monotributo','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,601,'Compras plaza','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2181,602,'Ventas plaza','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2183,50,'IVA-Bancas de Cubierta Colectiva','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2183,812,'CONTROL DE IMPUESTO','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,1,'TRigo propio-Existencia final (en ton.)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,2,'TRigo propio-Entradas comp.a no cont.IRIC-IRAE(ton','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,3,'TRigo propio-Entradas por Importaciones (en ton.)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,4,'TRigo propio-Salidas por molienda (en ton.)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,5,'TRigo propio-Salidas por exportaciones (en ton.)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,6,'TRigo propio-Otros movimientos (en ton.)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,7,'TRigo de Terceros-Existencia final (en ton.)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,8,'TRigo de terceros-Entradas no cont.IRIC-IRAE (ton)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,9,'TRigo de terceros-Salidas de no cont.IRIC-IRAE(ton','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,11,'Ventas Azucar con Destino No Industrial (en Kgs)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,12,'Ventas Alcoh.Carb. destino No elab. Naftas(en lts)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,401,'Trigo propio-Entradas p/Comp.a cont.IRIC-IRAE(ton)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,402,'Trigo propio-Salidas p/Vtas.a cont.IRIC-IRAE (ton)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,403,'Trigo de terceros-Entradas cont.IRIC-IRAE (ton)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,404,'Trigo de terceros-Salidas de cont.IRIC-IRAE (ton)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,405,'Trigo de terceros-Salidas por molienda (en ton.)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,406,'Vtas.Alcohol p/elab.beb.num.4','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,411,'Ventas Azucar con Destino Industrial (en Kgs)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,412,'Ventas Alcohol Carb. dest. elaborar Naftas(en lts)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,700,'Contribuyentes habilitados Res.12/2006 Num. 18','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,701,'Ventas nafta 97 a estaciones de frontera (en lts.)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,702,'Ventas nafta 95 a estaciones de frontera (en lts.)','2015-10-29 14:11:00');
INSERT INTO percepciones_retenciones VALUES (2185,703,'Ventas nafta 87 a estaciones de frontera (en lts.)','2015-10-29 14:11:00');
...
CREATE INDEX numeros_asignados_numero_id_cae_asignado_idx
    ON numeros_asignados USING btree
    (numero ASC NULLS LAST, id_cae_asignado ASC NULLS LAST);
